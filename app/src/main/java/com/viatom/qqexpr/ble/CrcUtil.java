...
public class CrcUtil {
	 ...
	 * CRC8 code table
	 */
	public static final char[] Table_CRC8 = { 0x00, 0x07, 0x0E, 0x09, 0x1C,
	...
	public static final char[] Table_CRC8_CCITT = {
	 ...
	 * @return CRC8 code, return 0 when the parameter is error
	 */
	public static byte calCRC8(byte[] buf, char[] crcTable) {
		if (buf == null || buf.length == 0) {
			return 0;
		}
		...
		for (int i = 0; i < buf.length-1; i++) {
			crc = (byte)crcTable[0x00ff & (crc ^ (buf[i]))];
		}
		return crc;
	}
	 ...
	 * @return CRC8 code, return 0 when the parameter is error
	 */
	public static byte calCRC8(byte[] buf, byte[] crcTable) {
		if (buf == null || buf.length == 0) {
			return 0;
		}
	 ...
	 * @return CRC8 code, return 0 when the parameter is error
	 */
	public static byte calCRC8ByCCITT(byte[] buf) {
		return calCRC8(buf, crc_table);
	}
}
